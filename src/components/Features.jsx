            ...
            <div className="feature-bx wow zoomIn">
              ...
              >
                <div className="item">
                  ...
                  <h5>Tomato Disease Detection using leaf images</h5>
                </div>
                <div className="item">
                  <img src={meter1} alt="feature_2" />
                  <h5>Classification of diseases on tomatoes</h5>
                </div>
                <div className="item">
                  <img src={meter1} alt="feature_3" />
                  <h5>Explanation of disease</h5>
                </div>
                <div className="item">
                  <img src={meter1} alt="feature_4" />
                  <h5>
                  Recommend appropriate treatment to resolve disease
                  </h5>
                </div>
              </Carousel>
            </div>
